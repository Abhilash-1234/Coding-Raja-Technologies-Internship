...
CREATE TABLE `loan_application` (
  ...
  `overall_income` varchar(100) DEFAULT NULL,
  `loan` varchar(100) DEFAULT NULL,
  `time_per` varchar(70) DEFAULT NULL,
...
INSERT INTO `loan_application` VALUES ('2507','vehicle','10000','50000','9','5040936002139835','9230984563');
